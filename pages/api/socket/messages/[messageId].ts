...
export default async function handler(
    ...
    res:NextApiResponseServerIO
        ...
        try {
            ...
            if(!serverId || !channelId || !messageId) return res.status(400).json({message: "Bad request."});
            ...
            if(!message || message.deleted) return res.status(404).json({message: "Message not found Or already deleted."});
