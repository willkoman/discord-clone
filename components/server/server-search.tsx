...
export const ServerSearch = ({
    ...
    return (
        <>
            ...
            className="group px-2 py-2 rounded-md flex items-center gap-x-2 w-full bg-zinc-200/70 dark:bg-zinc-900 hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition">
