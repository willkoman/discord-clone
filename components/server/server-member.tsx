...
const roleIconMap = {
    ...
    [MemberRole.MEMBER]: <Check className = "h-4 w-4 ml-2 text-green-500"/>,
}
...
export const ServerMember = ({
    ...
    return (
        ...
        params?.memberId === member.id && "bg-zinc-700/20 dark:bg-zinc-700")}>
            ...
            <p className={cn("text-sm font-semibold text-zinc-500 group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300 transition",
